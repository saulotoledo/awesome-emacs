...
[[https://github.com/emacs-tw/awesome-emacs/actions/workflows/main.yml][https://github.com/emacs-tw/awesome-emacs/actions/workflows/main.yml/badge.svg]]
...
*** Whitespaces Enhancement
    ...
    - [[https://github.com/your-username/trailing-newline-indicator][trailing-newline-indicator]] - Displays a small indicator at the end of the buffer to highlight trailing newlines.
...
*** Completion
    ...
    - [[https://github.com/lewang/flx][flx]] - Fuzzy matching for Emacs like Sublime Text.
      - [[https://github.com/jcs-elpa/flx-rs][flx-rs]] - flx in Rust using dynamic module.
...
*** Document
   ...
   - [[https://github.com/emacs-vs/docstr][docstr]] - A document string minor mode.
...
**** Clojure
     ...
     - [[https://github.com/ericdallo/jet.el][jet]] - Emacs integration for the jet Clojure tool.

**** Emacs Lisp
     - [[https://github.com/emacs-elsa/Elsa][Elsa]] - Emacs Lisp Static Analyzer and gradual type system.
     - [[https://github.com/elisp-lsp/ellsp][ellsp]] - Elisp Language Server.
...
*** Zig
    ...
    - [[https://codeberg.org/ziglang/zig-mode][zig-mode]] - An emacs major mode for the Zig programming language.
...
** Note
    ...
    - [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Spelling.html][flyspell]] - =[built-in]= On-the-fly spell checker.
    ...
    - [[https://github.com/joostkremers/writeroom-mode][writeroom-mode]] - Writeroom-mode: distraction-free writing for Emacs.
    - [[https://github.com/bastibe/annotate.el][annotate.el]] - annotate files without changing them.
    ...
    - [[https://github.com/emacs-grammarly/grammarly][grammarly]] - Grammarly API interface.
    - [[https://github.com/emacs-grammarly/lsp-grammarly][lsp-grammarly]] - Grammarly Language Server integration for Emacs.
    - [[https://github.com/mhayashi1120/Emacs-langtool][langtool]] - LanguageTool for Emacs.
    - [[https://github.com/emacs-languagetool/lsp-ltex][lsp-ltex]] - LTEX Language Server integration for Emacs.
...
** Tutorials
   ...
   - [[https://cestlaz.zamansky.net/cestlaz-old-hugo.github.io/stories/emacs/][C'est la Z - Using Emacs Series]] - A series of beginner-friendly Emacs tutorials by Mike Zamansky (@zamansky).
...
** Links and resources
   ...
   - [[https://github.com/emacs-tw/awesome-elisp][awesome-elisp]] - An awesome list for Elisp development.
